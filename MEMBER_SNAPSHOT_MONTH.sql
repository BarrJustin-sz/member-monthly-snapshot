...
SELECT
    ...
    , CASE WHEN CURRENT_DATE >= DATEADD('DAY', 33 * 1,  LAST_DAY(DATEADD('MONTH', -1, pb.MONTH_START))) THEN rt.RETAINED_M1       ELSE NULL END::FLOAT AS RETENTION_RETAINED_M1
    , CASE WHEN CURRENT_DATE >= DATEADD('DAY', 33 * 2,  LAST_DAY(DATEADD('MONTH', -1, pb.MONTH_START))) THEN rt.RETAINED_M2       ELSE NULL END::FLOAT AS RETENTION_RETAINED_M2
    , CASE WHEN CURRENT_DATE >= DATEADD('DAY', 33 * 3,  LAST_DAY(DATEADD('MONTH', -1, pb.MONTH_START))) THEN rt.RETAINED_M3       ELSE NULL END::FLOAT AS RETENTION_RETAINED_M3
    , CASE WHEN CURRENT_DATE >= DATEADD('DAY', 33 * 4,  LAST_DAY(DATEADD('MONTH', -1, pb.MONTH_START))) THEN rt.RETAINED_M4       ELSE NULL END::FLOAT AS RETENTION_RETAINED_M4
    , CASE WHEN CURRENT_DATE >= DATEADD('DAY', 33 * 5,  LAST_DAY(DATEADD('MONTH', -1, pb.MONTH_START))) THEN rt.RETAINED_M5       ELSE NULL END::FLOAT AS RETENTION_RETAINED_M5
    , CASE WHEN CURRENT_DATE >= DATEADD('DAY', 33 * 6,  LAST_DAY(DATEADD('MONTH', -1, pb.MONTH_START))) THEN rt.RETAINED_M6       ELSE NULL END::FLOAT AS RETENTION_RETAINED_M6
    , CASE WHEN CURRENT_DATE >= DATEADD('DAY', 33 * 9,  LAST_DAY(DATEADD('MONTH', -1, pb.MONTH_START))) THEN rt.RETAINED_M9       ELSE NULL END::FLOAT AS RETENTION_RETAINED_M9
    , CASE WHEN CURRENT_DATE >= DATEADD('DAY', 33 * 12, LAST_DAY(DATEADD('MONTH', -1, pb.MONTH_START))) THEN rt.RETAINED_M12_PLUS ELSE NULL END::FLOAT AS RETENTION_RETAINED_M12_PLUS
